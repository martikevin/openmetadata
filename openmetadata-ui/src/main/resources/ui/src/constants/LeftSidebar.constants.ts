...
import { ReactComponent as AccessIcon } from '../assets/svg/ic-alert.svg';
...
export const SIDEBAR_LIST: Array<LeftSidebarItem> = [
  ...
  {
    key: ROUTES.REQUEST_ACCESS,
    title: 'label.request-access',
    redirect_url: ROUTES.REQUEST_ACCESS,
    icon: AccessIcon,
    dataTestId: `app-bar-item-${SidebarItem.REQUEST_ACCESS}`,
  },
];
